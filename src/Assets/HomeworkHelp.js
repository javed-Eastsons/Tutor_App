...
const HomeworkHelp = ({ props, route }) => {
            ...
            <ScrollView>
                ...
                <View style={styles.postContainer}>
                    ...
                    <View style={styles.postLeft}>
                        <View>
                            <Image
                                source={require("../Assets/marketingHP.png")}
                        ...
                        >
                            <Text style={styles.postText}>Marking Assessments</Text>
                    ...
                    <View style={styles.postLeft}>
                        <View>
                            <Image
                                source={require("../Assets/missedHP.png")}
                                style={styles.posticons}
                            />
                        </View>
                        <TouchableOpacity
                        ...
                        >
                            <Text style={styles.postText}>No more missed Homework</Text>
                            <Text style={styles.postSemiText}>
                                •	Complete homework on time
                            </Text>
                            <Text style={styles.postSemiText}>
                                •	No more calls from teachers
                            </Text>
                            <Text style={styles.postSemiText}>
                    ...
                    <View style={styles.postLeft}>
                        <View>
                            <Image
                                source={require("../Assets/explainedHP.png")}
                                style={styles.posticons}
                            />
                        </View>
                        <TouchableOpacity
                        ...
                        >
                            <Text style={styles.postText}>Homework Explained</Text>
                            <Text style={styles.postSemiText}>
                                •	Detailed explanation on paper                                                           </Text>
                            <Text style={styles.postSemiText}>
                                •	Option available for audio explanation                                                          </Text>
                            <Text style={styles.postSemiText}>
                                •	Option available for video explanation                                                    </Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.postLeft}>
                        <View>
                            <Image
                                source={require("../Assets/projectHP.png")}
                                style={styles.posticons}
                            />
                        </View>
                        <TouchableOpacity
                            style={{ marginBottom: 10 }}
                        >
                            <Text style={styles.postText}>Project Guidance</Text>
                            <Text style={styles.postSemiText}>
                                •	Expert guidance for school projects                                                          </Text>
                            <Text style={styles.postSemiText}>
                                •	Proof reading essays                                                           </Text>
                            <Text style={styles.postSemiText}>
                                •	Help for Extended Essays                                                     </Text>
                        </TouchableOpacity>
                    </View>
