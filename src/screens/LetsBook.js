        ...
        <SafeAreaView style={{ flex: 1 ,marginHorizontal:10}}>
            ...
            <View style={[styles.Bookcard, styles.BookshadowProp,]}>
             ...
             <Text style={styles.BookText1}>Select Tution Type</Text>
                ...
                <View style={{height:"10%",width:"100%",position:"absolute",bottom:5,flexDirection:"row",alignSelf:"center",justifyContent:'space-around'}}>
                <TouchableOpacity 
                onPress={()=>navigation.goBack()}
                style={{height:"100%",width:"40%",backgroundColor:"#C0C0C0",justifyContent:"center",alignItems:"center",borderRadius:3}}>
            <Text style={styles.BookText}>Cancel</Text>
                ...
                style={{height:"100%",width:"40%",justifyContent:"center",alignItems:"center",backgroundColor:"#F6BE00",borderRadius:3}}>
