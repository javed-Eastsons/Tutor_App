...
const NegotiateTutor = ({route}) => {
  ...
  const SendRequest = (val) => {
    ...
    if(value == 'Negotiable')
    {
      navigation.navigate('AcceptTutor',{
        amount:offerAmount
      })
    }
    else{
     ...
     <View style={{height:wp(50),width:wp(40),
      backgroundColor:'#fff',borderRadius:20,margin:20,elevation:10}}>
        ...
        <Image
              ...
              style={styles.Dollaricons}
            />
<Text style={{fontSize:22,textAlign:"center",fontWeight:'700',color:'darkgreen'}}>Tutor Offer</Text>
     ...
     {/* <Text style={{color:'#2F5597',fontSize:14,fontWeight:'400', textAlign:'center'}}>Negotiable</Text> */}
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={styles.infoText1}>Next 010</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
