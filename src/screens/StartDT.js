...
const StartDT = ({ route }) => {
    ...
    const dateTimeOffer = () => {
        const Time = time.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
        const Date = moment(selectedStartDate ? selectedStartDate : date.toString()).format('MM-DD-YYYY')

        dispatch(offerDateTime(
            ...
            <View style={[styles.Bookcard, styles.BookshadowProp]}>
                ...
                <View style={styles.MainContainer}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', width: '100%', marginTop: 20 }}>
                        <View style={{ justifyContent: "center", alignItems: "center", width: '35%' }}>
                            <View style={{ width: '70%' }}>
                                <Text style={{ fontSize: 18, color: '#000', marginBottom: 20, width: '100%' }}>{time.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</Text>
                                <Button title="Select" color="#2F5597" onPress={showTimePicker} />
                            </View>
                        </View>
                ...
                </View>
                {
                    ...
                    student_offer_date && student_offer_time ?
                        <View style={{ marginTop: wp(15), height: wp(12), backgroundColor: '#2F5597', borderColor: '#2F5597', borderWidth: 1, flexDirection: 'row', marginBottom: 7, width: wp(100) }}>
                            <Text style={{ width: wp(40), backgroundColor: '#2F5597', color: '#fff', fontSize: 12, fontWeight: '500', margin: 10, }}>Your Start Date/Time</Text>
                            <View style={{ width: wp(60), height: wp(8), alignSelf: 'center', justifyContent: "center" }}>
                                <Text style={{ color: '#fff', fontSize: 12, fontWeight: '500' }}> {moment(
                                    student_offer_date,
                                    "MM-DD-YYYY"
                                ).format("ddd,DD MMM YYYY")}  {student_offer_time}</Text>
