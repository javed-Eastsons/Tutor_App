...
const NegotiateOffer = ({route}) => {
  ...
  const SendRequest = (val) => {
    ...
    if(value == 'Negotiable')
    {
      navigation.navigate('NegotiateTutor',{
        amount:offerAmount,
        youramount:youroffer
      })
    }
    else{
      navigation.navigate('NonNegotiateTutor',{
        amount:offerAmount,
        youramount:youroffer
      })
     ...
     <View style={{height:wp(50),width:wp(40),
      backgroundColor:'#fff',borderRadius:20,margin:20,elevation:10}}>
        ...
        <Image
            ...
            />
<Text style={{fontSize:22,textAlign:"center",fontWeight:'700',color:'#2F5597'}}>Client's Offer</Text>
...
/>
    ...
    <Text style={{textAlign:"center",color:"#2F5597",fontSize:14,marginTop:wp(3)}}>Negotiable</Text>    
     ...
     <View style={{height:wp(50),width:wp(40),
      backgroundColor:'#fff',borderRadius:20,margin:20,elevation:10}}>
        ...
        <Image
              ...
              style={styles.Dollaricons}
            />
<Text style={{fontSize:22,textAlign:"center",fontWeight:'700',color:'darkgreen'}}>Your Offer</Text>

  <View style={{flexDirection:'row', height:50,backgroundColor:"darkgreen",marginTop:wp(5),justifyContent:"center"}}>
      
    <Text style={{color:'#fff',fontSize:16,fontWeight:'600',alignSelf:"center",}}>SGD</Text>
      
<TextInput
  style={{
    height:40,backgroundColor:"darkgreen",width:45,
    color:'#fff',fontSize:18,marginRight:4,fontWeight:'500',alignSelf:"center",
  }}
  keyboardType="numeric"
  value={youroffer}
  onChangeText = {text => setYourOffer(text)}
  placeholderTextColor="#fff"
  placeholder="0.00"
...
/>
    ...
    <Text style={{textAlign:"center",color:"darkgreen",fontSize:14,marginTop:wp(3)}}>{value}</Text>    

     </View>
     </View>

     <View style={{marginTop:wp(5),height:wp(12),borderColor:'darkgreen',borderWidth:1,flexDirection:'row',}}> 
     <Text style={{width:wp(48),color:'darkgreen',fontSize:16,fontWeight:'500',margin:10,marginLeft:20}}>SGD    {youroffer}.00   / hour</Text>
     <View style={{width:wp(40),height:wp(9),borderWidth:1,borderColor:'darkgreen',alignSelf:'center',justifyContent:"center"}}>
     {/* <Text style={{color:'#2F5597',fontSize:14,fontWeight:'400', textAlign:'center'}}>Negotiable</Text> */}
   
                 {/* {renderLabel()} */}
                 <Dropdown
                  style={[styles.dropdown, isFocus && { borderColor: "black" }]}
                  placeholderStyle={{ fontSize: 16 ,color:"darkgreen"}}
                  selectedTextStyle={styles.selectedTextStyle}
                  itemTextStyle={{color:"darkgreen"}}
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={styles.infoText1}>Next 01</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
