...
const ChatWithTutors = ({ props, route }) => {
            ...
            <ScrollView>
                ...
                <View style={styles.usercontainer}>
                    <View style={styles.UserLeft}>
                        <Text style={styles.text1}>Chat with Tutors</Text>
                ...
                <View style={styles.postContainer}>
                    ...
                    <View style={styles.postLeft}>
                        ...
                        >
                            <Text style={styles.postSemiText}>You have access to a large pool of qualified tutors. You now need to decide which tutor suits you best.</Text>
                            <Text style={styles.postText}> Sounds Challenging?</Text>
                    ...
                    <View style={styles.postLeft}>
                        ...
                        >
                            <Text style={styles.postSemiText}>
                                Use our chat feature to narrow the field of prospective tutors. Share your tuition concerns and get their response
                            </Text>
                            <Text style={styles.postText}> Get to know your tutor</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.postLeft}>
                        <View>
                        ...
                        >
                            <Text style={styles.postSemiText}>
                                You now are in a good position to select your perfect tutor. Tuition concerns have been shared & the tutor is ready

                            </Text>
                            <Text style={styles.postText}> Onward to Success!</Text>
                        </TouchableOpacity>
                    </View>
