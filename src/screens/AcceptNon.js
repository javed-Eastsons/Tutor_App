...
/>
    ...
    <Text style={{textAlign:"center",color:"#2F5597",fontSize:14,marginTop:wp(3)}}>Non Negotiable</Text>    
     ...
     <Text style={{width:wp(45),backgroundColor:'#2F5597', color:'#fff',fontSize:15,fontWeight:'500',margin:10,marginLeft:20}}>Agreed Start Date/Time</Text>
     <View style={{width:wp(45),height:wp(8),alignSelf:'center',justifyContent:"center"}}>
     <Text style={{color:'#fff',fontSize:15,fontWeight:'500'}}>{moment(route.params.mydate.toString()).format('ddd,MMMM Do')}  {moment(route.params.mytime.toLocaleTimeString('en-US'),"HH:mm").format("hh:mm A")}</Text>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() =>Alert.alert("go to payment")
