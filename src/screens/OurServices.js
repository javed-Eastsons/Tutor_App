                ...
                <View style={styles.postContainer}>
                    ...
                    <View style={styles.postLeft}>
                        <View style={{
                            ...
                            < Image
                                source={require("../Assets/ser3.png")}
                        ...
                        >
                            ...
                            <Text style={styles.postSemiText}>
                                Home Tuition is face to face lessons conducted at the student’s home. It is popular & considered most effective.

                            </Text>
                            <Text style={styles.postText}> Personal Interaction</Text>
                    ...
                    <View style={styles.postLeft}>
                        <View>
                            <Image
                                source={require("../Assets/ser2.png")}
                                style={styles.posticons}
                            />
                        </View>
                        <TouchableOpacity
                        ...
                        >
                            ...
                            <Text style={styles.postSemiText}>
                                Student & tutor interact in a virtual classroom for Online Tuition. You can engage the best tutor without travel.

                            </Text>
                            <Text style={styles.postText}> Effective & Convenient</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.postLeft}>
                        <View>
                            <Image
                                source={require("../Assets/ser1.png")}
                                style={styles.posticons}
                            />
                        </View>
                        <TouchableOpacity
                        ...
                        >
                            <Text style={styles.postSemiText}>
                                Homework Help provides assistance when required. No more incomplete assignments or missed deadlines!

                            </Text>
                            <Text style={styles.postText}>Prompt Response</Text>
                        </TouchableOpacity>
                    </View>
