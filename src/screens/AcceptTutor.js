...
/>
    ...
    <Text style={{textAlign:"center",color:"darkgreen",fontSize:14,marginTop:wp(3)}}>{value}</Text>    
     ...
     <Text style={{width:wp(90),color:'#fff',fontSize:16,fontWeight:'500',margin:10,textAlign:"center"}}>Agreed Fee is SGD {offerAmount}.00  /hour</Text>
